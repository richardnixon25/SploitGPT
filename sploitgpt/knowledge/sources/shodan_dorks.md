# Shodan Dorks (embedded)

Source: https://github.com/nullfuzz-pentest/shodan-dorks (snapshot pulled for offline use, upstream license: GPL-3.0; see third_party/shodan-dorks.LICENSE).

Use these queries with the `shodan_search` tool or directly with the Shodan API. Combine them with location/org/port filters as needed and keep usage lawful and scoped.
